...
var QuotesPulseProvider = /** @class */ (function() {
  ...
  QuotesPulseProvider.prototype._updateQuotes = function(updateType) {
    ...
    var _loop_1 = function(listenerGuid) {
      ...
      this_1._quotesProvider.getQuotes(
        updateType === 1 /* Fast */ ? subscriptionRecord.fastSymbols : subscriptionRecord.symbols,
      )
        .then(function(data) {
          ...
          logMessage(
            "QuotesPulseProvider: data for #" + listenerGuid + " (" + updateType + ") updated successfully, pending="
              + _this._requestsPending,
          );
        })
        .catch(function(reason) {
          _this._requestsPending--;
          logMessage(
            "QuotesPulseProvider: data for #" + listenerGuid + " (" + updateType + ") updated with error="
              + getErrorMessage(reason) + ", pending=" + _this._requestsPending,
          );
        });
    };
    var this_1 = this;
