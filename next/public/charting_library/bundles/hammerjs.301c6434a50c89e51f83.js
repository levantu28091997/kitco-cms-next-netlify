(window.webpackJsonp = window.webpackJsonp || []).push([["hammerjs"], {
  be1f: function(t, e, n) {
    "use strict";
    n.r(e);
    var i = n("yLV6"), r = n.n(i);
  ...
  yLV6: function(t, e, n) {
    ...
    !function(r, s, o, a) {
      ...
      function q(t, e, n) {
        var i = n.pointers.length, r = n.changedPointers.length, s = 1 & e && i - r == 0, o = 12 & e && i - r == 0;
        n.isFirst = !!s,
          n.isFinal = !!o,
          s && (t.session = {}),
          n.eventType = e,
          function(t, e) {
            ...
            var s = n.firstInput, o = n.firstMultiple, a = o ? o.center : s.center, h = e.center = H(i);
            e.timeStamp = f(),
            ...
            e.overallVelocityX = u.x,
              ...
              e.maxPointers = n.prevInput
                ? e.pointers.length > n.prevInput.maxPointers ? e.pointers.length : n.prevInput.maxPointers
                : e.pointers.length,
              function(t, e) {
                var n, i, r, s, o = t.lastInterval || e, a = e.timeStamp - o.timeStamp;
                if (8 != e.eventType && (a > 25 || void 0 === o.velocity)) {
                  var h = e.deltaX - o.deltaX, u = e.deltaY - o.deltaY, c = V(a, h, u);
      ...
      function tt() {
        this.evEl = K, this.evWin = Q, k.apply(this, arguments), this.store = this.manager.session.pointerEvents = [];
      }
      ...
      function it(t, e) {
        var n = D(t.touches), i = D(t.changedTouches);
      ...
      function ot(t, e) {
        var n = D(t.touches), i = this.targetIds;
        if (3 & e && 1 === n.length) return i[n[0].identifier] = !0, [n, n];
        var r, s, o = D(t.changedTouches), a = [], h = this.target;
        if (
      ...
      E(st, k, {
        handler: function(t) {
          var e = rt[t.type], n = ot.call(this, t, e);
          n
            && this.callback(this.manager, e, {
              pointers: n[0],
              changedPointers: n[1],
      ...
      dt.prototype = {
        ...
        E(Tt, dt, {
          ...
          process: function(t) {
            var e = this.state, n = t.eventType, i = 6 & e, r = this.attrTest(t);
        ...
        E(Et, Tt, {
          ...
          directionTest: function(t) {
            ...
            return r & e.direction || (6 & e.direction
          ...
          attrTest: function(t) {
            return Tt.prototype.attrTest.call(this, t)
        ...
        E(It, Tt, {
          ...
          attrTest: function(t) {
            return this._super.attrTest.call(this, t)
        ...
        E(St, Tt, {
          ...
          attrTest: function(t) {
            ...
            return 30 & n ? e = t.overallVelocity : 6 & n ? e = t.overallVelocityX : 24 & n && (e = t.overallVelocityY),
              this._super.attrTest.call(this, t) && n & t.offsetDirection && t.distance > this.options.threshold
              && t.maxPointers == this.options.pointers && p(e) > this.options.velocity && 4 & t.eventType;
          },
          emit: function(t) {
      ...
      wt.prototype = {
        ...
        recognize: function(t) {
          ...
          if (!e.stopped) {
            ...
            var i = this.recognizers, r = e.curRecognizer;
