(window.webpackJsonp = window.webpackJsonp || []).push([[57], {
  bR4N: function(t, e, a) {
    "use strict";
    var s = a("wmOI").ESC, n = a("e3/o").guid, o = a("jAh7").getRootOverlapManager;
    a("eL+L");
    var p = function(t, e, i) {
      ...
      var r = function() {},
        ...
        u = {},
        h = function(c, h, f) {
          var v = n(), g = c.target.ownerDocument, m = g.defaultView, b = o(g), C = h || e;
          ...
          function x(t) {
            if (u.preventFirstProcessClick) {
              u.preventFirstProcessClick = !1;
            } else {
              var e = $(t.target).parents().andSelf();
              e.is(".charts-popup-tab-headers, .charts-popup-itemheader") || i.notCloseOnButtons && e.is(".icon-delete")
                || d();
            }
          }
          function y(t) {
          ...
          i.listInner && (k = $("<div class=\"list-inner\">").appendTo(k)),
                ...
                if (s instanceof p.TabGroup) {
                  ...
                  $.each(s.tabs || [], function(t, a) {
                    if (a.items && a.items.length) {
                      ...
                      var o = $("<span class=\"charts-popup-tab-header\">").append(
                  ...
                  if (s.title) {
                    var u = $("<div class=\"charts-popup-itemheader\"></div>").text(s.title).prepend(
                  ...
                  if (s.date) {
                    f = $("<span class=\"title\"></span>").appendTo(h),
                      $("<span class=\"date\"></span>").text(s.date || "").appendTo(h);
                  ...
                  if (
                    s.buttons instanceof Array && s.buttons.length && s.buttons.forEach(function(t) {
                    ...
                    if ("function" == typeof s.counter) {
                      ...
                      $("<span class=\"counter\"></span>").text(s.counter + "").addClass(y).appendTo(h);
                    }
                  }
            ...
            i.upAction && $(g).on("selectstart.popup-menu", function() {
              return !1;
            }),
          ...
          var W = !!i.reverse;
          if ("down" === R) {
            var O = D - E.top - A - G - B - P, F = E.top - G - B - P;
            O < Math.max(z || 0, 100) && F > O && (R = "up");
          } else if ("right" === R) {
            var j = M - E.left - L - G - B - P, J = E.left - G - B - P;
          ...
          if (
            ...
            parseInt(T.css("left")) + T.width() + B > V && T.css("left", V - T.width() - B + "px").css("right", "auto");
          }
          i.careBottomBorder && parseInt(T.css("top")) + T.height() + B > D + I
