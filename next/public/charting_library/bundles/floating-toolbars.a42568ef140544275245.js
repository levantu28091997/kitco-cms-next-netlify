  ...
  "0ZwQ": function(t, e, o) {
    ...
    var i = o("P5fv"),
      ...
      g = function(t) {
        ...
        return Object(h.__extends)(e, t),
          e.prototype._startLoading = function() {
            return o.e("hammerjs").then(o.bind(null, "be1f")).then(function(t) {
              return t.HammerJS;
            });
          },
          e;
    ...
    var C = "<div class=\"tv-floating-toolbar i-closed i-hidden\">"
        + (Modernizr.mobiletouch ? "<div class=\"tv-floating-toolbar__drag-ext js-drag\"></div>" : "")
        + "<div class=\"tv-floating-toolbar__widget-wrapper\"><div class=\"tv-floating-toolbar__drag js-drag\">" + f
      ...
      x = function() {
        function t(e) {
          this._widget = document.createElement("div"),
            ...
            this._options.layout && "auto" !== this._options.layout
        ...
        return t.prototype.destroy = function() {
          ...
          t.prototype._onWindowResize = function() {
            if ("auto" === (this._options.layout || "auto")) {
              var t = this._isVertical, e = this._getCorrectedWidgetRect();
          ...
          t.prototype._checkPosition = function() {
            var t = this._getCorrectedWidgetRect(), e = { left: t.left, top: t.top };
          ...
          t.prototype._getCorrectedWidgetRect = function() {
            ...
            if (this._widget.classList.contains("i-closed")) {
              var e = t.width * (1 / .925 - 1), o = t.height * (1 / .925 - 1);
              return {
                bottom: t.bottom + o / 2,
                height: t.height + o,
                left: t.left - e / 2,
          ...
          h = (o("TXAa"),
            function(e) {
              function o(t) {
                ...
                return o._linetoolsWidgets = {},
                  o._canBeShownValue = new u.a(!1),
                  o._attachHandlers(),
                  o._loadVisibilityState(),
                  o;
              }
              return Object(i.__extends)(o, e),
                ...
                o.prototype._renderAllLinetools = function() {
                  ...
                  this._linetoolsWidgets = {},
                    this.removeWidgets(),
                    r.a.favorites().filter(function(t) {
                      return d.a[t];
                    }).forEach(function(e) {
    ...
    var i = o("Eyy1"),
      ...
      r = function() {
        ...
        return t.prototype.setContainer = function(t) {
          var e = this._container, o = null === t ? this._document.createDocumentFragment() : t;
          !function(t, e) {
      ...
      l = (o("m/4m"),
        ...
        function(t) {
          function e(o) {
            ...
            return i._onWidgetStateChangedDelegate = new a.a(),
              i._statedWidgets = [],
              i._currentPopup = null,
              i._onWindowClickedListener = i._onWindowClicked.bind(i),
              i;
          }
          return Object(i.__extends)(e, t),
            ...
            e.prototype.addGroupedWidget = function(t, o) {
              ...
              var r = { isEnabled: !0, statedWidget: t, toolbarWidget: i }, s = this._onWidgetClicked.bind(this, r);
              r.clickListener = s,
            ...
            e.prototype.findGroupedWidget = function(t) {
              for (
                var e = this._statedWidgets.length, o = 0;
                o < e;
                ++o
            ...
            e.prototype.removeGroupedWidget = function(t) {
              for (var e = this._statedWidgets.length, o = 0; o < e; ++o) {
                ...
                if (i.statedWidget.id === t) {
                  return this._isPopupCreatedForWidget(t) && this._closePopup(),
            ...
            e.prototype._createPopup = function(t) {
              ...
              t.statedWidget.states.forEach(function(n, r) {
                var s = e._createSubWidget(t, n), a = e._onSubWidgetClicked.bind(e, t, n.id);
            ...
            e.prototype._closePopup = function() {
              ...
              if (
                ...
                var e = this._currentPopup.widgets, o = this._currentPopup.element;
            ...
            e.prototype._createSubWidget = function(t, e) {
              ...
              return o.className += "tv-grouped-floating-toolbar__sub-widget",
  ...
  tPkB: function(t, e, o) {
    ...
    (function(e, i) {
      ...
      o("m/4m"),
        ...
        w.prototype.findSourceOnWidget = function(t) {
          for (var e = 0; e < this.activeChartWidget().model().panes().length; e++) {
            for (
              var o = this.activeChartWidget().model().panes()[e].orderedSources(), i = 0;
              i < o.length;
              i++
            ) {
              if (o[i] === t) return o[i];
        ...
        w.prototype._isSyncOperationAvailable = function() {
          return !!h(this._chartWidgetCollection.layout.value())
        ...
        w.prototype._cloneButtonTitle = function() {
          var t = $.t("Clone");
          return e.enabled("datasource_copypaste") && (t += ", " + $.t("Copy")),
        ...
        w.prototype._createSourceActions = function() {
          var t = [];
          return e.enabled("property_pages")
            && t.push({
        ...
        w.prototype._getZOrderActions = function() {
          ...
          return 1 === e.length && e[0].zorder() === a.minZOrder && (n.disabled = !0, s.disabled = !0),
        ...
        w.prototype._getPossibleProperty = function(t) {
          ...
          return t.extendLeft || (e = e.map(function(t) {
            return "leftEnd" === t.name && (t.comboboxOptions = t.comboboxOptions.filter(function(t) {
              return t.value !== w.LINE_EXTEND;
            })),
              t;
          })),
            t.extendRight || (e = e.map(function(t) {
              return "rightEnd" === t.name && (t.comboboxOptions = t.comboboxOptions.filter(function(t) {
                return t.value !== w.LINE_EXTEND;
              })),
                t;
            })),
        ...
        w.prototype._updateVisibility = function() {
          this._propertiesVisible || this._sourceActionsVisible || this._templatesVisible ? this._show() : this.hide();
        },
        ...
        w.prototype._setupToggleLockButton = function(t) {
          t !== this._selectedSourceBk
            && (this._selectedSourceBk && this._selectedSourceBk.properties().frozen
              && this._selectedSourceBk.properties().frozen.unsubscribe(this, this._lockChangeListener),
              t && t.properties().frozen
        ...
        w.prototype.colorPropertyControl = function(t, e, o) {
          ...
          var n = i.find("input"), r = $(e.iconSvgCode);
        ...
        w.prototype.createLineEndPropertyProxy = function(t, e) {
          return function(o, n) {
            ...
            var s = new i(r);
            return s.subscribe(this, function(i) {
              var r = i.value();
              r < 2
      ...
      w.prototype._defaultToolProperties = function() {
        return [{ name: "color", inputType: "colorPicker", iconSvgCode: I, title: $.t("Color") }, {
          name: "linecolor",
          ...
          name: "linewidth",
          inputType: "combobox",
          comboboxOptions: [{ value: 1, iconSvgCode: P }, { value: 2, iconSvgCode: S }, { value: 3, iconSvgCode: T }, {
            value: 4,
            iconSvgCode: L,
          }],
          title: $.t("Width"),
          ...
          title: $.t("Style"),
          inputType: "combobox",
          comboboxOptions: [{ value: 0, iconSvgCode: P }, { value: 1, iconSvgCode: E }, { value: 2, iconSvgCode: k }],
        }, {
          name: "leftEnd",
          title: $.t("Left End"),
          inputType: "combobox",
          comboboxOptions: [{ value: u.Normal, iconSvgCode: B }, { value: u.Arrow, iconSvgCode: z }, {
            value: w.LINE_EXTEND,
            iconSvgCode: V,
          }],
          ...
          title: $.t("Right End"),
          inputType: "combobox",
          comboboxOptions: [{ value: u.Normal, iconSvgCode: M }, { value: u.Arrow, iconSvgCode: A }, {
            value: w.LINE_EXTEND,
            iconSvgCode: F,
          }],
        ...
        w.prototype._riskPropertiesExceptionCases = function() {
          return [{ name: "textcolor", title: $.t("Text color"), inputType: "colorPicker", iconSvgCode: H }, {
        ...
        w.prototype._rangeExceptionCases = function() {
          return [{ name: "linecolor", inputType: "colorPicker", iconSvgCode: I, title: $.t("Color") }, {
            name: "backgroundColor",
            inputType: "colorPicker",
            iconSvgCode: O,
            title: $.t("Background Color"),
        ...
        w.prototype._notePropertiesExceptionCases = function() {
          return [{ name: "markerColor", title: $.t("Marker Color"), inputType: "colorPicker", iconSvgCode: I }, {
            name: "textColor",
            title: $.t("Text color"),
            inputType: "colorPicker",
            iconSvgCode: H,
        ...
        w.prototype._arrowMarkPropertiesExceptionCases = function() {
          return [{ name: "arrowColor", title: $.t("Arrow color"), inputType: "colorPicker", iconSvgCode: O }, {
            name: "color",
            title: $.t("Text color"),
            inputType: "colorPicker",
            iconSvgCode: H,
        ...
        w.prototype._buttonsForGrouppedProperties = function(t, e) {
          ...
          return t
            ...
            && o.push({
              name: "linewidth",
              inputType: "combobox",
              comboboxOptions: [{ value: 1, iconSvgCode: P }, { value: 2, iconSvgCode: S }, {
                value: 3,
                iconSvgCode: T,
              }, { value: 4, iconSvgCode: L }],
              factory: w.prototype._createWidthsButton,
