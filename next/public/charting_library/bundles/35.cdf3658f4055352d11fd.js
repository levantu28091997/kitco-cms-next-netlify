  ...
  DxCR: function(t, e, i) {
    ...
    (function(t) {
      ...
      function M(t, e, i, r, o, n, s, a) {
        v.call(this, t, e, r, o, n), this._transformFunction = i, this._propertyChangedHook = a, this._setter = s;
        var l = this;
        r && t.change(function() {
      ...
      function E(e, i, r, o, n, s) {
        ...
        var a = this;
        function l(t, e) {
          var i = a.control().slider("option", "min"), r = a.control().slider("option", "max"), o = a._property.value();
            ...
            $(n).each(function() {
              $(this).on("keydown", function(t) {
                parseInt($(n[0]).val()) < l._transformers[0]
                  ...
                  -1 !== $.inArray(t.keyCode, [46, 8, 9, 27, 13, 110, 190]) || 65 === t.keyCode && !0 === t.ctrlKey
                  || 67 === t.keyCode && !0 === t.ctrlKey || 88 === t.keyCode && !0 === t.ctrlKey
      ...
      _.prototype.model = function() {
        ...
        _.prototype.loadData = function() {
          for (var t = 0; t < this._bindings.length; t++) {
            ...
            } else {e.property && (e.transparencyProperty && e.transparencyProperty()
        ...
        _.prototype.createSeriesMinTickEditor = function() {
          ...
          for (var i in e) {
            var r = e[i];
            t += "<option value='" + (r.priceScale + "," + r.minMove + "," + r.frac) + "'>"
              + (r.minMove + "/" + r.priceScale) + "</option>";
          }
          return t += "</select>", $(t);
        },
        ...
        _.prototype.createLabeledCell = function(t, e, i) {
          ...
          var s = this._labelToId(r), a = $("<td>");
          return $("<label>").html(r.length > 0 ? $.t(r) : "").attr("for", s).appendTo(a),
            n && a.attr("colspan", n),
            o && o.attr("id", s),
            a;
        },
        ...
        C.prototype.setValue = function(t) {
          var e = this._control.val(), i = this._formatValue(t);
        ...
        k.prototype._parseSessions = function(t) {
          var e = t.split("-", 2);
          2 !== e.length && (e = ["0", "0"]);
          var i = parseInt(e[0]), r = parseInt(e[1]);
        ...
        T.prototype.value = function() {
          ...
          var t = this._control.val(), e = this._toIntTransformer(t);
          e < 0 && (e = 0);
          var i = this._mainSeries.bars().size();
          return i <= e && (e = i - 1),
            1e3 * o(this._mainSeries.bars().valueAt(o(this._mainSeries.bars().lastIndex()) - e))[TradingView.TIME_PLOT];
        },
        ...
        w.prototype.setValue = function(t) {
          if (
            this.control().is(".visibility-checker") && (t
            ...
            var e = { opacity: t ? 1 : .5 }, i = t ? "enable" : "disable", r = this.control().data("hides");
            if (r) r.closest("td").css(e);
            else {
              var o = this.control();
              o.parent().parent().data("visible", t).find("td").filter(function() {
                var t = $(this);
      ...
      void 0 === (n = "function" == typeof (r = function(t) {
            return t.widget("ui.slider", t.ui.mouse, {
              ...
              _createHandles: function() {
                var e, i, r = this.options, o = this.element.find(".ui-slider-handle"), n = [];
                for (
              ...
              _mouseCapture: function(e) {
                var i, r, o, n, s, a, l, c = this, u = this.options;
                return !u.disabled
                    ...
                    && (this._mouseSliding = !0,
                      ...
                      this._clickOffset = l
                        ...
                        : {
                          ...
                          top: e.pageY - a.top - n.height() / 2 - (parseInt(n.css("borderTopWidth"), 10) || 0)
                            - (parseInt(n.css("borderBottomWidth"), 10) || 0) + (parseInt(n.css("marginTop"), 10) || 0),
                        },
              ...
              _slide: function(t, e, i) {
                var r, o = this.value(), n = this.values();
                ...
                && (r = this.values(e ? 0 : 1),
                  ...
                  n[e] = i),
                  i !== o && !1 !== this._trigger("slide", t, this._uiHash(e, i, n))
              ...
              _setOption: function(e, i) {
                var r, o = 0;
                switch (
                  "range" === e && !0 === this.options.range && ("min" === i
              ...
              _trimAlignValue: function(t) {
                ...
                var e = this.options.step > 0 ? this.options.step : 1, i = (t - this._valueMin()) % e, r = t - i;
                ...
                this._hasMultipleValues()
                  ? this.handles.each(function(r) {
                    i = (l.values(r) - l._valueMin()) / (l._valueMax() - l._valueMin()) * 100,
                      ...
                      !0 === l.options.range && ("horizontal" === l.orientation
                        ? (0 === r && l.range.stop(1, 1)[c ? "animate" : "css"]({ left: i + "%" }, a.animate),
                          1 === r
                          && l.range[c ? "animate" : "css"]({ width: i - e + "%" }, { queue: !1, duration: a.animate }))
                        : (0 === r && l.range.stop(1, 1)[c ? "animate" : "css"]({ bottom: i + "%" }, a.animate),
                          1 === r
                          && l.range[c ? "animate" : "css"]({ height: i - e + "%" }, {
                            queue: !1,
                            duration: a.animate,
                          }))),
                      e = i;
              ...
              _handleEvents: {
                keydown: function(e) {
                  ...
                  switch (
                    o = this.options.step, i = r = this._hasMultipleValues() ? this.values(n) : this.value(), e.keyCode
                  ) {
                    case t.ui.keyCode.HOME:
                      r = this._valueMin();
                      break;
  ...
  "Y+MS": function(t, e, i) {
    ...
    var r = function() {
      ...
      return t.prototype.calculateRollerPosition = function(t) {
        var e = t.pageX - this.$gradient.offset().left, i = this.$gradient.width();
        ...
        t.prototype.updateColor = function() {
          var t = this.colorInput.val() || "black", e = this.toRgb(t);
          $.browser.msie
            ? this.$gradient.css(
              "filter",
              ["progid:DXImageTransform.Microsoft.gradient(startColorstr='", e, "', EndColor=0, GradientType=1)"].join(
                "",
              ),
            )
            : [
    ...
    !function(t) {
      ...
      function b(y) {
          ...
          return t.each(e, function(e, s) {
            ...
            var l = t("<td class=\"tvcolorpicker-cell\"></td>").appendTo(r),
              h = t("<div class=\"tvcolorpicker-transparency\"><div class=\"tvcolorpicker-swatch\"></div></div>")
                .appendTo(l).find(".tvcolorpicker-swatch").data("color", s);
        ...
        function $(i) {
          ...
          var F = w.height(), R = w.width(), A = !1, H = !1, z = !0, L = [0, 0, .5];
          function N(t) {
          ...
          function U(e) {
            var i = function(e) {
              var i = e.pageY, r = t(D), o = i - r.offset().top;
          ...
          t("<a class=\"tvcolorpicker-custom-button _tv-button\">" + window.t("Custom color...") + "</a>").appendTo(b)
            .bind("click", function() {
          ...
          return b.append(
            t(M.call(this, e, { addClass: "tvcolorpicker-user" })).addClass("tvcolorpicker-user-swatches"),
          ),
            t(m.body).append(b),
            function(e, i, r) {
              var o,
        ...
        function w() {
          ...
          t(i).find(".tvcolorpicker-popup").removeClass("opened").remove(),
            ...
            t(S).each(function() {
              ...
              r && r != t(this).val() && t(this).trigger("change"), t(this).removeData("tvcolorpicker-previous-color");
            });
        }
        function V(t) {
        ...
        var S = this;
        return y && "customColors" in y && r(y.customColors),
          this.each(function() {
            var e = t(this);
            e.val(i(e.val()));
            var r = null, o = !1;
              ...
              e.data("tvcolorpicker")
                || (w.call(e),
                  ...
                  r.bind("mousedown click", function(i) {
                    t(i.target).parents().andSelf().is(r) && (e.focus(),
                      o = !0,
                      setTimeout(function() {
                        o = !1;
                      }, 0));
