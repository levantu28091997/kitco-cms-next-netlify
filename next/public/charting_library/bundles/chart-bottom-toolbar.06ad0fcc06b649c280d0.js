(window.webpackJsonp = window.webpackJsonp || []).push([["chart-bottom-toolbar"], {
  ...
  "02pg": function(e, t, n) {
    ...
    var a = n("q1tI"), i = n("TSYQ"), o = n("XiJV");
    function r(e) {
  ...
  "J+f8": function(e, t, n) {
    ...
    var a = n("q1tI"), i = a.createContext(!1);
  },
  J3OW: function(e, t, n) {
  ...
  K3s3: function(e, t, n) {
    ...
    var a = n("mrSG"), i = n("q1tI"), o = n("TSYQ"), r = n("Eyy1"), s = n("5o6O"), c = s;
    function l(e) {
      var t,
        n = o(
          e.className,
      ...
      return function(t) {
        ...
        return Object(a.__extends)(n, t),
          ...
          n.prototype.render = function() {
            var t = this, n = this.props.className, a = this._generateTabs();
          ...
          n.prototype._generateTabs = function() {
            var e = this;
            return this.activeTab.current = null,
          ...
          n.prototype._componentDidUpdate = function() {
            ...
            if (this.activeTab.current) {
              var t = this.activeTab.current.offsetWidth, n = this.activeTab.current.offsetLeft;
  ...
  MfqI: function(e, t, n) {
      ...
      x = function() {
        ...
        return e.prototype.state = function() {
          ...
          e.prototype.selectRange = function(e) {
            ...
            var t = this._context.chartWidgetCollection, n = { val: e.value, res: e.targetResolution };
            t.setTimeFrame(n);
          },
          e.prototype.destroy = function() {
            var e = this, t = this._context.chartWidget;
            t.withModel(null, function() {
              var n = t.model(), a = n.mainSeries();
          ...
          e.prototype._updateAvailableRanges = function() {
            var e = this._context, t = e.availableTimeFrames, n = e.chartWidget;
            if (n.model()) {
              var a = n.model().mainSeries(), i = a.status();
    ...
    var N = new WeakMap(), k = n("cdbK"), W = n("l4ku"), M = n("02pg"), T = n("9VJd"), O = n("J3OW");
    function j(e) {
      var t = e.ranges, n = e.activeRange, a = e.onSelectRange;
    ...
    var B = { title: window.t("Date Range"), goToDate: window.t("Go to...") },
      ...
      z = R(function(e) {
        function t(t, n) {
          ...
          return i._handleGoToDateClick = function() {
            ...
            i._renderChildren = function(e) {
              var t = i.props, n = t.ranges, o = t.activeRange, r = t.goToDateButton;
              return e
                ? a.createElement(
                  a.Fragment,
                  null,
    ...
    var P = n("nPPD"), q = n("RZ2Z"), G = Object(P.a)(I.a, q);
    var U = n("qSb5"),
    ...
    var V = R(function(e) {
        var t = e.className, n = e.ranges, i = e.activeRange, o = e.onSelectRange;
        return a.createElement(
          H,
        ...
        function t(t) {
          ...
          return n._element = null,
            ...
            n._showMenu = function() {
              ...
              var e = n.props, t = e.getActions, a = e.right, i = Object(v.ensureNotNull)(n._element), o = t();
              0 !== o.length && oe.ContextMenuManager.createMenu(o).then(function(e) {
                n._menu = e,
                  e.show(function(e, t) {
    ...
    var le = Object(C.b)(),
      ue = function(e) {
        function t(t, n) {
          var a = e.call(this, t, n) || this;
          return a._timeFormatter = new ae.TimeFormatter(),
            a._tickInterval = void 0,
            a._tickClock = function() {
              var e = a.context.chartApiInstance, t = a._timezoneOffset;
              if (void 0 !== t) {
                var n = 1e3 * e.serverTimeOffset(), i = new Date(Date.now() + t + n);
        ...
        return Object(r.__extends)(t, e),
          t.prototype.componentDidMount = function() {
            var e = this, t = this.context.chartWidget;
          ...
          t.prototype.render = function() {
            var e = this.props, t = e.className, n = e.withMenu, i = this.state, o = i.time, r = i.timezone;
            return a.createElement(
              re,
        ...
        (Se = function(e) {
          ...
          return Object(r.__extends)(t, e),
            t.prototype.componentDidMount = function() {
              var e = this, t = this.context.chartWidget;
              t.withModel(null, function() {
                var n = t.model().mainSeries(), a = n.priceScale();
            ...
            t.prototype.render = function() {
              var e = this.props.className, t = this.state, n = t.isActive, i = t.series;
      ...
      Me = function(e) {
        ...
        return (t = function(t) {
          ...
          return Object(r.__extends)(n, t),
            ...
            n.prototype.render = function() {
              var t = this.props.className, n = this.state, i = n.isActive, o = n.series;
              return a.createElement(e, {
                className: t,
                isAuto: i,
                isDisabled: null === o,
        ...
        return (t = function(t) {
          function n(e, n) {
            ...
            a._handleClick = function(e) {
              var t = a.context, n = t.resizerDetacher;
            ...
            return a.state = { isFullscreen: i.fullscreen.value(), isChangeLayoutButton: a._isChangeLayoutButton() }, a;
          }
          return Object(r.__extends)(n, t),
            n.prototype.componentDidMount = function() {
              var e = this.context, t = e.resizerDetacher;
            ...
            n.prototype.render = function() {
              var t = this.props.className, n = this.state, i = n.isFullscreen;
    ...
    var Le =
      ...
      Pe = function(e) {
        function t(t, n) {
          var i, r, s = e.call(this, t, n) || this;
          s._timezoneButtonRef = null,
            ...
            s._handleResize = function() {
              null === s._raf && (s._raf = requestAnimationFrame(function() {
                var e,
                  t,
                  n,
                  a,
                ...
                if (Object.assign(i, { dateRangeMode: p }), "expanded" !== p) {
                  for (
                    var m = u - Object(v.ensureNotNull)(s._rangeCollapsed).offsetWidth - 0, g = 0, b = 0, f = 0, _ = l;
                    f < _.length;
                    f++
                  ) {
                    var C = _[f];
        ...
        return Object(r.__extends)(t, e),
          t.prototype.componentDidMount = function() {
            var e = this.context, t = e.onContentBoxChanged, n = e.resizerDetacher;
            ...
            return a.createElement(
              ...
              a.createElement(
                ...
                a.createElement(
                  ...
                  !1,
                  !1,
                  this.props.percentageScaleButtonEnabled && !d.enabled("fundamental_widget")
                  ...
                  this.props.fullscreenButtonEnabled && this.state.isFullscreenable
                    && a.createElement(Ae, {
                      className: Ne.icon,
          ...
          t.prototype._applyResizing = function() {
            var e = this, t = this._layout, n = t.dateRangeMode, a = Object(r.__rest)(t, ["dateRangeMode"]);
            this._rangeExpanded && this._rangeExpanded.classList.toggle(Ne.collapsed, "expanded" !== n),
              ...
              Object.keys(a).forEach(function(t) {
                var n = t, i = e._seriesComponents[n];
  ...
  "w+Rv": function(e, t, n) {
    ...
    var a = n("q1tI"), i = n("TSYQ"), o = n.n(i), r = n("ycgn");
    function s(e) {
      var t = e.text, n = void 0 === t ? "" : t, i = e.className;
