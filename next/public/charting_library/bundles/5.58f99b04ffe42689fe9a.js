(window.webpackJsonp = window.webpackJsonp || []).push([[5], {
    ...
    var o = n("mrSG"),
      ...
      d = function(t) {
        function e() {
          ...
          return e._manager = new s.OverlapManager(),
            e._handleSlot = function(t) {
              e._manager.setContainer(t);
            },
            e;
        }
        return Object(o.__extends)(e, t),
          ...
          e.prototype._createStyles = function() {
            var t = this.props, e = t.bottom, n = t.left, o = t.width;
            return { bottom: e, left: n, right: t.right, top: t.top, zIndex: t.zIndex, maxWidth: o, height: t.height };
          },
          e;
      }(i.PureComponent);
  },
  RgaO: function(t, e, n) {
    ...
    var o = n("mrSG"), i = n("8Rai");
    function r(t) {
      var e = t.children, n = Object(o.__rest)(t, ["children"]);
    ...
    var g = function() {
          ...
          void 0 === n && (n = { boundByScreen: !0 }),
            ...
            this._onTouchDragEnd = function(t) {
              o._header.removeEventListener("touchmove", o._onTouchDragMove),
                o._onDragStop(),
                o._canBeTouchClick && (o._canBeTouchClick = !1,
                  function(t) {
        ...
        return t.prototype.destroy = function() {
          ...
          t.prototype._dragStart = function(t) {
            ...
            var n = Math.round(e.left), o = Math.round(e.top);
          ...
          t.prototype._dragMove = function(t) {
            ...
            if (this._drag) {
              ...
              this._frame = requestAnimationFrame(function() {
                if (e._drag) {
                  var n = t.x - e._drag.startX, o = t.y - e._drag.startY;
      ...
      f = function() {
        function t(t, e) {
          ...
          void 0 === e && (e = { vertical: 0 }),
            ...
            this._handleResize = function() {
              null === n._frame && (n._frame = requestAnimationFrame(function() {
        ...
        return t.prototype.updateOptions = function(t) {
          ...
          t.prototype.recalculateBounds = function() {
            ...
            var t = document.documentElement, e = t.clientHeight, n = t.clientWidth;
        ...
        return Object(o.__extends)(e, t),
          e.prototype.render = function() {
            ...
            return i.createElement(
              v.a.Provider,
              { value: this },
              i.createElement(c.a, { mouseDown: !0, touchStart: !0, handler: this.props.onClickOutside }, function(e) {
                return i.createElement(
                  "div",
                  {
                    ref: e,
          ...
          e.prototype.componentDidMount = function() {
            ...
            this.props.autofocus && t.focus(),
              ...
              this.props.isAnimationEnabled && this.props.growPoint
          ...
          e.prototype._applyAppearanceAnimation = function(t) {
            if (this._resize && this._dialog) {
              var e = t.x, n = t.y, o = this._resize.getDialogsTopLeftCoordinates(), i = o.x, r = o.y;
  ...
  pafz: function(t, e, n) {
    ...
    var o = n("q1tI"), i = o.createContext(null);
  },
  uqKQ: function(t, e, n) {
    "use strict";
    n.d(e, "a", function() {
    ...
    var o = n("mrSG"), i = n("q1tI"), r = n("AiMB");
    function a(t) {
      return function(e) {
        function n() {
          return null !== e && e.apply(this, arguments) || this;
        }
        return Object(o.__extends)(n, e),
          n.prototype.render = function() {
            var e = this.props, n = e.isOpened, a = e.root;
            if (!n) return null;
