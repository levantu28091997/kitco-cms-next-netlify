(window.webpackJsonp = window.webpackJsonp || []).push([["change-interval-dialog"], {
  MuC6: function(t, i, e) {
    "use strict";
    ...
    _.prototype._setInput = function() {
      this._input = $("<input type=\"text\" class=\"change-interval-input\" autocomplete=\"off\" maxlength=\"7\">"),
        this._input.on("keypress", this._handleInput.bind(this)).on(
          "input",
          function() {
      ...
      _.prototype._validate = function() {
        ...
        if (this._supported) {
          ...
          else if (null === i || "H" === i) this._parsed.qty * ("H" === i ? 60 : 1) > 1440 && (this._supported = !1);
      ...
      _.prototype.show = function(t) {
        ...
        return i.css("min-width", 0),
          e.css("min-width", 0).mousedown(function(t) {
