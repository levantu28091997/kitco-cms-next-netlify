(window.webpackJsonp = window.webpackJsonp || []).push([[20], {
  ...
  kSQs: function(t, e, o) {
    "use strict";
    var r = o("mrSG"), i = o("q1tI"), s = o("TSYQ"), n = o("uqKQ"), h = o("i8i4");
    var a = o("Db/h"), p = o("Ialn");
    o.d(e, "a", function() {
      return u;
    });
    var c,
        ...
        (c = d,
          (l = function(t) {
            function e(e) {
              ...
              return o._getComponentInstance = function(t) {
                o._instance = t;
              },
            ...
            return Object(r.__extends)(e, t),
              ...
              e.prototype.componentDidUpdate = function(t) {
                var e = this;
                t.children === this.props.children && t.top === this.props.top && t.left === this.props.left
                    && t.width === this.props.width || this.setState(this._getStateFromProps(), function() {
              ...
              e.prototype._getStateFromProps = function() {
                return {
                  ...
                  width: this.props.inheritWidthFromTarget
                    ...
                    : this.props.width,
                  maxWidth: this.props.inheritMaxWidthFromTarget && this.props.target
              ...
              e.prototype._calcTargetProps = function(t, e, o) {
                var r = t.getBoundingClientRect(),
                  ...
                  s = "parent" === this.props.root
                    ? this._getCoordsRelToParentEl(t, r)
                    : this._getCoordsRelToDocument(r);
                if (null === s) return null;
                var n = this._getDimensions(i), h = this._getDimensions(r).width, a = 0, p = 0;
                switch (e.vertical) {
                  case "top":
                    p = s[o.vertical];
                    break;
                ...
                return "number" == typeof this.props.attachmentOffsetY && (p += this.props.attachmentOffsetY),
                  "number" == typeof this.props.attachmentOffsetX && (a += this.props.attachmentOffsetX),
                  { x: a, y: p, width: h };
              },
              e.prototype._getCoordsRelToDocument = function(t) {
                var e = pageYOffset, o = pageXOffset, r = t.top + e, i = t.bottom + e, s = t.left + o;
                return {
                  top: r,
                  bottom: i,
                  left: s,
              ...
              e.prototype._getCoordsRelToParentEl = function(t, e) {
                ...
                var r = o.scrollTop, i = o.scrollLeft, s = t.offsetTop + r, n = t.offsetLeft + i, h = e.width + n;
                return {
                  top: s,
                  bottom: e.height + s,
                  left: n,
