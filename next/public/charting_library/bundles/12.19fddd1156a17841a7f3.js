      ...
      function(t) {
        ...
        function v(t) {
          ...
          if (
            ...
            var h = Math.round(c + o) - e, v = Math.round(a + s) - n;
            1 !== Math.abs(h) && (c -= h), 1 !== Math.abs(v) && (a -= v);
          }
          return b(r.left, r.top, c, a);
        }
        var _ = "undefined" != typeof SVGGraphicsElement
          ? function(t) {
        ...
        var y = function(t, e) {
          ...
          w = function(t, e, i) {
            if (
              this.activeObservations_ = [], this.observations_ = new n(), "function" != typeof t
        ...
        var g = "undefined" != typeof WeakMap ? new WeakMap() : new n(),
          E = function(t) {
            ...
            if (!arguments.length) throw new TypeError("1 argument required, but only 0 present.");
            var e = a.getInstance(), n = new w(t, e, this);
            g.set(this, n);
          };
