...
var r = function() {
  function t(t) {
    ...
    "Dark" === this._options.theme && void 0 === this._options.loading_screen
    && (this._options.loading_screen = { backgroundColor: "#131722" }), this._create();
  }
    ...
    t.prototype._render = function() {
      ...
      if (
        t[this._id] = {
          ...
          && (t[this._id].chartContentExtendedData = this._options.saved_data_meta_info);} else if (
        !this._options.load_last_chart && !this._options.symbol
      ) throw new Error("Symbol is not defined: either 'symbol' or 'load_last_chart' option must be set");
      var e = (this._options.library_path || "")
        + (encodeURIComponent(this._options.locale) + "-tv-chart.b555c6a4.html#symbol=")
        + encodeURIComponent(this._options.symbol || "") + "&interval=" + encodeURIComponent(this._options.interval)
        ...
        + encodeURIComponent(String(this._options.client_id)) + "&userId="
        + encodeURIComponent(String(this._options.user_id)) + (this._options.charts_storage_url
      ...
      return "<iframe id=\"" + this._id + "\" name=\"" + this._id + "\"  src=\"" + e + "\""
        + (this._options.autosize || this._options.fullscreen
          ? ""
...
window.TradingView = window.TradingView || {}, window.TradingView.version = i, exports.version = i, exports.widget = r;
