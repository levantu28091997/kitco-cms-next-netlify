// @ts-ignore
// TODO:
// this is gonna recieve a mega refactor.
// this is really only used on the forex and crypto pages.
// kitco is gonna send us a spec for what they want in regards to those pages
// procrastinate for the mean time sorry
...
export default class TradingViewWidget extends React.Component<any, any> {
  static propTypes = {
  ...
  updateOnloadListener = (onload) => {
    ...
    const oldOnload: any = script.onload;
  ...
  initWidget = () => {
    ...
    const config: any = { ...widgetConfig, container_id: this.containerId };
